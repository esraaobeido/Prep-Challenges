...
const customerAndAge = (obj) => {
  // write your code here
    let Output = [];
    for (let customerName in obj) {
      const age = obj[customerName];
      Output.push(`Customer Name :${customerName} , Age :${age}`);
    }
  ...
  // write your code here
    ...
    for (let [key, value] of Object.entries(obj)) {
      if (key === "name") {
        ...
        output.push("ingredients: " + value.join(","));
      } else if (key === "cookTime") {
        output.push("cookTime: " + value);
      } else if (key === "price") {
        output.push("price: " + value + "$");
      }
    }
    return output;
};
